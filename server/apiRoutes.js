...
const soccerApiHeaders = {'X-Auth-Token': SOCCER_DATA_API_KEY};
...
router.get('/api/soccerTeams', (req, res) => {
    axios.get(`${soccerApiBaseUrl}/competitions/2000/teams`, {headers: soccerApiHeaders}).then((soccerTeamsResponse) => {
